...
class nn(object):
    ...
    def linear_backward(self, dZ, cache):
        """
        Description: the linear portion of backward propagation for a single layer (layer l)
    ...
    def linear_activation_backward(self, dA, cache, activation):
        """
        Description: the backward propagation for the LINEAR->ACTIVATION layer.
    ...
    def L_model_backward(self, AL, Y, caches):
        ...
        """
        Description: the backward propagation for the [LINEAR->RELU] * (L-1) -> LINEAR -> SIGMOID group
    ...
    def update_parameters(self, parameters, grads, learning_rate):
        """
        Description: Update parameters using gradient descent
